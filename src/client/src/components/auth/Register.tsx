    ...
    return (
      <div>
        <div id="surround-form">
          ...
          <Paragraph>
            <b>Hey there!</b> Setup your profile and we'll take it from there.
          </Paragraph>
            ...
            <Form.Item label="Enter the URL to your profile picture">
              {getFieldDecorator("profilePicLink", {
                rules: [
                  {
                    required: true,
                    message: "Please enter the link to your profile picture!"
                  }
                ]
              })(
                <Input
            ...
            <Form.Item label="Enter your password">
              {getFieldDecorator("password", {
                rules: [
                  {
                    required: true,
                    message: "Please Choose a Secure Password!"
                  },
                  {
